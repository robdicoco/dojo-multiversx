...
[![Challenge 1 Details](https://img.shields.io/badge/Challenge%201-Details%20here-blue?style=for-the-badge&logo=markdown)](./solutions/week-01/challenge1-en.md)

### 📌 Week 2: TypeScript & Basic ELIZA

**Start:** 02/19  
**Submission:** 02/25

**Goal:** Introduction to TypeScript and the ELIZA Framework for decentralized application development.

### 📌 Week 3: Intermediate Smart Contracts

**Start:** 02/26  
**Submission:** 03/03

**Goal:** Advance in smart contract development by exploring intermediate features.
...
**Goal:** Develop advanced smart contracts and implement best security practices.

### 📌 Week 6: Advanced ELIZA I

**Start:** 03/19  
**Submission:** 03/25

**Goal:** Explore advanced ELIZA Framework features to integrate blockchain solutions.

### 📌 Week 7: Advanced Smart Contracts II

**Start:** 03/26  
**Submission:** 04/01

**Goal:** Complete the development of advanced smart contracts.

### 📌 Week 8: Advanced ELIZA II

**Start:** 04/02  
**Submission:** 04/08

**Goal:** Refine the use of the ELIZA Framework for blockchain project integration.

### 📌 Week 9: Integration I

**Start:** 04/09  
**Submission:** 04/15

**Goal:** Start integrating the technologies developed in previous weeks.

### 📌 Week 10: Integration II

**Start:** 04/16  
**Submission:** 04/22

**Goal:** Continue the integration and ensure interoperability of the solutions.

### 📌 Week 11: Integration III

**Start:** 04/23  
**Submission:** 04/29

**Goal:** Refine and test the complete integration of the technologies.

### 📌 Week 12: Integration IV

**Start:** 04/30  
**Submission:** 05/06

**Goal:** Finalize the integration and prepare the project for the final presentation.
...
|    **Week**    |              **Theme**              |                     **Description**                      | **Start** | **Submission** |     **Status**     |
| :------------: | :---------------------------------: | :------------------------------------------------------: | :-------: | :------------: | :----------------: |
| ⚪ **Week 01** | 🛠 **Rust & Basic Smart Contracts**  |        Fundamentals of Rust and first contracts.         | **02/12** |   **02/18**    |  🔄 _In progress_  |
| 🟡 **Week 02** |   🖥 **TypeScript & Basic ELIZA**    |     Introduction to TypeScript and ELIZA Framework.      | **02/19** |   **02/25**    | ⏳ _Pending start_ |
| 🟢 **Week 03** | 🔐 **Intermediate Smart Contracts** |            Intermediate contract development.            | **02/26** |   **03/03**    | ⏳ _Pending start_ |
| 🟣 **Week 04** |      📦 **Intermediate ELIZA**      |     Implementation of more complex ELIZA solutions.      | **03/05** |   **03/11**    | ⏳ _Pending start_ |
...
| 🔷 **Week 09** |        ⚙️ **Integration I**         |      Start integrating the developed technologies.       | **04/09** |   **04/15**    | ⏳ _Pending start_ |
| 🔷 **Week 10** |        ⚙️ **Integration II**        |            Continue the integration process.             | **04/16** |   **04/22**    | ⏳ _Pending start_ |
| 🔷 **Week 11** |       ⚙️ **Integration III**        |               Refinement and final tests.                | **04/23** |   **04/29**    | ⏳ _Pending start_ |
| 🔷 **Week 12** |        ⚙️ **Integration IV**        | Finalization and preparation for the final presentation. | **04/30** |   **05/06**    | ⏳ _Pending start_ |
